...
def main():
    try:
            ...
            for tweet in mentions['data']:
                try:
                    ...
                    if (translated_text):
                        ...
                        reply_text = f"Hello! You can get your text converted to NVC language by mentioning '@nvctranslator' followed by your message."
        ...
        logger.error(
            f"An unexpected error occurred in the main function: {main_exception}")
...
if __name__ == "__main__":
    ...
    while 1:
        try:
            ...
            logger.error(
                f"An unexpected error occurred in the main loop: {outer_exception}")
